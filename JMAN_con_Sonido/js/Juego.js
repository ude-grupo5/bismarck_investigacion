...
var estadoH;
	...
	//juego.load.audio('ambiente','audio/viento.wav');		
	juego.load.audio('ambiente','audio/musicaGuerra.wav');		
	juego.load.audio('sonidoBarco','audio/Barco.wav');				
	juego.load.audio('sonidoDisparo', 'audio/disparo.mp3');	
	juego.load.audio('sonidoImpactoBala', 'audio/explosionImpacto.wav');		
	juego.load.audio('sonidoExplosionFinal', 'audio/explosionFinal.wav');	
	juego.load.audio('sonidoAgua', 'audio/Splash.wav');	
...
function create() {
	...
	//Sonidos
	SonidoAmbiente = juego.add.audio('ambiente');
    SonidoAmbiente.loopFull();
    SonidoBarco =  juego.add.audio('sonidoBarco');
	//SonidoBarco.loopFull();
	
	SonidoDisparo = juego.add.audio('sonidoDisparo');
    SonidoExplosion = juego.add.audio('sonidoImpactoBala');
    SonidoExplosionFinal = juego.add.audio('sonidoExplosionFinal');
	SonidoAgua = juego.add.audio('sonidoAgua');
